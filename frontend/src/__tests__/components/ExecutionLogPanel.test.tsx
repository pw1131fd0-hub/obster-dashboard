...
describe('ExecutionLogPanel', () => {
  ...
  it('displays log filenames', () => {
    ...
    expect(screen.getByText('exec-20260417-001.json')).toBeDefined();
    expect(screen.getByText('exec-20260417-002.json')).toBeDefined();
  });

  it('displays timestamps', () => {
    render(<ExecutionLogPanel />);
    expect(screen.getByText('2026-04-17T12:00:00.000Z')).toBeDefined();
    expect(screen.getByText('2026-04-17T11:55:00.000Z')).toBeDefined();
  });
